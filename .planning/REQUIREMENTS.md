...
| CONF-09 | Phase 118.2 | Pending — minted 2026-08-11 at Phase 118.2 planning time per D-17, with a table row from the outset so the existing 10-orphan-ID traceability warning is not widened. Owns the FIRST of CONF-07's two named preconditions (the client half of G-3), signed off as **OPEN** at plan `118.1-13`'s D-10 gate |
| CONF-10 | Phase 118.2 | Pending — minted 2026-08-11 at Phase 118.2 planning time per D-17. Owns the SECOND of CONF-07's two named preconditions (the `notifications/message` emitter). Scores the official suite's `tools-call-with-logging`, the last gap-attributable failure after Phase 118.1 |
