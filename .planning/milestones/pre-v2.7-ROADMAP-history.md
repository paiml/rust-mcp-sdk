# Pre-v2.7 ROADMAP history (archived 2026-09-02)

Verbatim carry-over of every ROADMAP.md section that predated the v2.7 milestone and was
NOT already captured by its own `.planning/milestones/vX.Y-ROADMAP.md` archive.

Milestones v1.0–v1.4, v2.0, v2.5 and v2.6 have their own archives and are only indexed in
the live ROADMAP. Milestones **v2.1, v2.2, v2.3 and v2.4** were never separately archived —
their full phase detail lives here and nowhere else, which is why this file exists rather
than the sections simply being deleted at the v2.6 close.

The Backlog section is NOT here: it stays live in `.planning/ROADMAP.md`.
