...
| 119-03 · T1 | DOCS-06 | The example-build baseline is recorded before the loop is touched | structural | `test -f .planning/phases/119-*/119-03-BASELINE.md` | ⬜ pending (wave 2) |
...
| 119-09 · T2 | DOCS-04 | The `## Examples` block's cited invocations build | build | `cargo build --example s50_v2_tasks_server --example s51_v2_tasks_a…` | ⬜ pending (wave 4) |
